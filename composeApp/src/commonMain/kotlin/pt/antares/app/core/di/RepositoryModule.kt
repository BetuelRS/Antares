...
val repositoryModule = module {
    ...
    single { FoodRepository(get(), get(), get(), get(), get(), get(IoDispatcher)) }
    ...
    single { RecipeRepository(get(), get(), get(), get(), get(), get(), get(IoDispatcher)) }
    ...
    single { ExerciseLibraryRepository(get(), get(), get(), get(), get(IoDispatcher)) }
    single { RoutineRepository(get(), get(), get(), get(), get(IoDispatcher)) }
    ...
    single { WorkoutHistoryRepository(get(), get(), get(), get(), get(IoDispatcher)) }
