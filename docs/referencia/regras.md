...
Este repositório já provou qual é o filtro. Há **88 testes-guarda** documentados em
[Testes-guarda](testes-guarda.md) — 87 classes de teste em Kotlin mais um `.test.mjs` das
