...
Este repositório já provou qual é o filtro. Há **77 testes-guarda** documentados em
[Testes-guarda](testes-guarda.md) — 76 classes de teste em Kotlin mais um `.test.mjs` das
