...
Este repositório já provou qual é o filtro. Há **87 testes-guarda** documentados em
[Testes-guarda](testes-guarda.md) — 86 classes de teste em Kotlin mais um `.test.mjs` das
