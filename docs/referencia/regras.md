...
Este repositório já provou qual é o filtro. Há **75 testes-guarda** documentados em
[Testes-guarda](testes-guarda.md) — 74 classes de teste em Kotlin mais um `.test.mjs` das
