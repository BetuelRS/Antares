...
Este repositório já provou qual é o filtro. Há **84 testes-guarda** documentados em
[Testes-guarda](testes-guarda.md) — 83 classes de teste em Kotlin mais um `.test.mjs` das
