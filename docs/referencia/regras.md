...
Este repositório já provou qual é o filtro. Há **81 testes-guarda** documentados em
[Testes-guarda](testes-guarda.md) — 80 classes de teste em Kotlin mais um `.test.mjs` das
