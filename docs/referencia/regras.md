...
Este repositório já provou qual é o filtro. Há **86 testes-guarda** documentados em
[Testes-guarda](testes-guarda.md) — 85 classes de teste em Kotlin mais um `.test.mjs` das
