...
Este repositório já provou qual é o filtro. Há **90 testes-guarda** documentados em
[Testes-guarda](testes-guarda.md) — 89 classes de teste em Kotlin mais um `.test.mjs` das
