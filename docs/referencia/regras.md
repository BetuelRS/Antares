...
Este repositório já provou qual é o filtro. Há **74 testes-guarda** documentados em
[Testes-guarda](testes-guarda.md) — 73 classes de teste em Kotlin mais um `.test.mjs` das
