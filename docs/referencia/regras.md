...
Este repositório já provou qual é o filtro. Há **85 testes-guarda** documentados em
[Testes-guarda](testes-guarda.md) — 84 classes de teste em Kotlin mais um `.test.mjs` das
