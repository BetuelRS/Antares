...
Vinte e nove é muito, e o risco é conhecido: uma lista longa lê-se uma vez e nunca
mais. A defesa é a coluna da direita.

Este repositório já provou qual é o filtro. Há **57 testes-guarda** documentados em
