...
Este repositório já provou qual é o filtro. Há **76 testes-guarda** documentados em
[Testes-guarda](testes-guarda.md) — 75 classes de teste em Kotlin mais um `.test.mjs` das
