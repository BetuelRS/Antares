...
| `MarcaDoUtilizadorSobreviveTest` | os favoritos, os recentes, as porções guardadas e as lápides desaparecerem quando o catálogo é substituído | uma das quatro colunas deixou de viajar dentro da linha nova. Não dá erro: a pessoa é que, um dia, abre os favoritos e estão vazios |
